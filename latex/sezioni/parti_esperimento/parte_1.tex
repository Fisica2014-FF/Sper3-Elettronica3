...
\begin{grafico} \centering \input{../grafici/risultati/amp_inv.tex} \caption{Curva di trasferimento di un amplificatore invertente} \label{gr:amp_inv.tex} \end{grafico}
\begin{tabella}
 \centering
 %inserire tabella
...
\begin{grafico} \centering \input{../grafici/risultati/amp_noninv.tex} \caption{Curva di trasferimento di un amplificatore invertente} \label{gr:amp_noninv.tex} \end{grafico}
\begin{tabella}
 \centering
 %inserire tabella
 \caption{Dati curva di trasferimento}
