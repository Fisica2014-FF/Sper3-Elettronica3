...
L'errore è stato poi calcolato effettuando una propagazione degli errori sulla $f_b$, tenendo conto anche dell'alta correlazione tra i coefficienti della retta ($-0.9995$).\\%da fare
$f_b= 215 \pm 7 \,kHz $\\
Il GBP è\\
...
In seguito sono presentati i dati del  \autoref{gr:amp_noninv_A1.tex} acquisiti in laboratorio:
% \begin{tabella}
%  \centering
